...
function calculateEggs(chickens: number, eggsPerChicken: number): number {
    return chickens * eggsPerChicken;
}

// Arrow Function
const calculateEggsArrow = (chickens: number, eggsPerChicken: number): number => {
    return chickens * eggsPerChicken;
};

// Shorthand Arrow Function
const calculateEggsShort = (chickens: number, eggsPerChicken: number): number =>
    chickens * eggsPerChicken;
